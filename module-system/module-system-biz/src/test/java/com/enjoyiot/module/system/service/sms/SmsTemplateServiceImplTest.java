...
public class SmsTemplateServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetSmsTemplatePage() {
        ...
        SmsTemplateDO dbSmsTemplate = randomPojo(SmsTemplateDO.class, o -> { // 等会查询到
            ...
            o.setCode("tudou");
            o.setContent("EnjoyIot");
            o.setApiTemplateId("ENJOY");
            o.setChannelId(1L);
        ...
        smsTemplateMapper.insert(ObjectUtils.cloneIgnoreId(dbSmsTemplate, o -> o.setApiTemplateId("ENJOY")));
        // 测试 channelId 不匹配
