...
public class CodegenServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateCodegenList() {
        ...
        CodegenCreateListReqVO reqVO = randomPojo(CodegenCreateListReqVO.class,
                o -> o.setDataSourceConfigId(1L).setTableNames(Collections.singletonList("t_test")));
        // mock 方法（TableInfo）
        TableInfo tableInfo = mock(TableInfo.class);
        when(databaseTableService.getTable(eq(1L), eq("t_test")))
                .thenReturn(tableInfo);
        when(tableInfo.getComment()).thenReturn("ENJOY");
        ...
        AdminUserRespDTO user = randomPojo(AdminUserRespDTO.class, o -> o.setNickname("ENJOY"));
        ...
        assertEquals("ENJOY", dbTable.getAuthor());
        // 断言（CodegenColumnDO）
    ...
    public void testSyncCodegenFromDB() {
        ...
        CodegenTableDO table = randomPojo(CodegenTableDO.class, o -> o.setTableName("t_test")
        ...
        // mock 方法（TableInfo）
        TableInfo tableInfo = mock(TableInfo.class);
        when(databaseTableService.getTable(eq(1L), eq("t_enjoy")))
                .thenReturn(tableInfo);
        when(tableInfo.getComment()).thenReturn("ENJOY");
        // mock 方法（TableInfo fields）
        TableField field01 = mock(TableField.class);
    ...
    public void testGetCodegenTablePage() {
        ...
        CodegenTableDO tableDO = randomPojo(CodegenTableDO.class, o -> {
            o.setTableName("t_enjoy");
            o.setTableComment("ENJOY");
            o.setClassName("SystemEnjoy");
        ...
        reqVO.setTableName("enjoy");
        reqVO.setTableComment("ENJOY");
        reqVO.setClassName("Enjoy");
    ...
    public void testGetDatabaseTableList() {
        ...
        when(tableInfo01.getName()).thenReturn("t_enjoy");
        when(tableInfo01.getComment()).thenReturn("ENJOY");
        TableInfo tableInfo02 = mock(TableInfo.class);
        when(tableInfo02.getName()).thenReturn("t_enjoy_02");
        when(tableInfo02.getComment()).thenReturn("enjoy_02");
        ...
        // 断言
        assertEquals(1, result.size());
        assertEquals("t_enjoy", result.get(0).getName());
        assertEquals("ENJOY", result.get(0).getComment());
    }
