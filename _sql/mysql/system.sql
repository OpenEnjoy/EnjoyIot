...
INSERT INTO `eiot`.`eiot_component` (`id`, `name`, `type`, `config`, `status`, `remark`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (2, '内置emqx协议组件', 'emqx', '{\n     \"port\": 1883,\n     \"host\": \"127.0.0.1\",\n     \"topics\": \"/sys/#\",\n     \"authPort\": 8104\n}', 1, NULL, NULL, '2025-02-19 01:01:54', '1', '2025-02-28 10:29:51', b'0');
