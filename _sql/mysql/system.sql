...
CREATE TABLE `eiot_device_alert_config` (
    ...
    `product_key` varchar(100) NULL COMMENT '产品Key（产品级配置时必填）',
    `device_id` bigint NULL COMMENT '设备ID（设备级配置时必填）',
    `level` varchar(10) DEFAULT '1' COMMENT '告警等级 1-5',
    `conditions` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT COMMENT '告警条件配置',
    `trigger_options` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT COMMENT '触发控制选项',
...
CREATE TABLE `eiot_device_alert_record` (
    ...
    `product_key` varchar(100) NULL COMMENT '产品Key',
    ...
    `recover_time` bigint NULL COMMENT '告警恢复时间',
    `creator` varchar(64) NULL DEFAULT '' COMMENT '创建者',
    `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    `updater` varchar(64) NULL DEFAULT '' COMMENT '更新者',
    `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
